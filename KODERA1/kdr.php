<html>
	...
	<body id='mainBody'>
        ...
        //===================================================================================KOMAX 2
		echo " <table>   <tr><th class='stretchtext'>B1-KD04</th></tr> ";
		$i = 0;
		while($i < count($wos1)) {
		    if ($bool1[$i] == 1){
			$color = "red";
        ...
        //===================================================================================KOMAX 3  
		echo " <table >   <tr><th class='stretchtext'>B2-KX02</th></tr> ";
		$i = 0;
		while($i < count($wos2)) {
		    if ($bool2[$i] == 1){
			$color = "red";
        ...
        //===================================================================================KOMAX 4
		echo " <table>   <tr><th class='stretchtext'>B2-KX03</th></tr> ";
			$i = 0;
		while($i < count($wos3)) {
		    if ($bool3[$i] == 1){
			$color = "red";
        ...
        //===================================================================================KOMAX 5
		echo " <table>   <tr><th class='stretchtext'>B2-KX05</th></tr> ";
		$i = 0;
		while($i < count($wos4)) {
		    if ($bool4[$i] == 1){
			$color = "red";
        ...
        //===================================================================================KODERA 1
		echo " <table >   <tr><th class='stretchtext'>B2-KD01</th></tr> ";
		$i = 0;
		while($i < count($wos5)) {
		    if ($bool5[$i] == 1){
			$color = "red";
